...
const GAMES = [
  {
    ...
    description: 'A technical word flashes briefly — can you remember and type it within 30 seconds?',
    icon: Keyboard,
    color: '#4285F4',
    bgLight: 'bg-[#e8f0fe]',
    path: '/arcade/words',
  ...
  },
  {
    ...
    description: 'See an AI-generated image and write the prompt you think created it. Closest wins!',
    icon: Brain,
    color: '#EA4335',
    bgLight: 'bg-[#fce8e6]',
  ...
  },
  {
    ...
    description: "Find the one tech product or company that doesn't belong with the others.",
    icon: Ghost,
    color: '#9C27B0',
    bgLight: 'bg-[#f3e5f5]',
  ...
  },
  {
    ...
    description: 'Answer Google & tech trivia questions in just 10 seconds each. How fast are you?',
    icon: Zap,
    color: '#EA4335',
    bgLight: 'bg-[#fce8e6]',

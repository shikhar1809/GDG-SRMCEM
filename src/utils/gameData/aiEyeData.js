...
const real = (id, seed, subject = 'real-world photo') => ({
  id,
  isAI: false,
  subject,
  src: `/game-images/ai-eye/${id}.jpg`,
...
export const AI_EYE_IMAGES = [
  ...
  // --- real photographs ------------------------------------------------------
  real('real_01', 'gdgreal01', 'mountain lake landscape'),
  real('real_02', 'gdgreal02', 'weathered mechanical object'),
  real('real_03', 'gdgreal03', 'wooden dock by water'),
  real('real_04', 'gdgreal04', 'modern building facade'),
  real('real_05', 'gdgreal05', 'city skyline'),
  real('real_06', 'gdgreal06', 'misty forest overlook'),
  real('real_07', 'gdgreal07', 'rocky coastline'),
  real('real_08', 'gdgreal08', 'flat lay electronic parts'),
  real('real_09', 'gdgreal09', 'flat lay desk objects'),
  real('real_10', 'gdgreal10', 'small boat on calm water'),
  real('real_11', 'gdgreal11', 'blue water surface'),
  real('real_12', 'gdgreal12', 'weathered apartment facade'),
  real('real_13', 'gdgreal13', 'ocean waves from above'),
  real('real_14', 'gdgreal14', 'mountain valley landscape'),
];
